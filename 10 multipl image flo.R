...
P.less.0.05 <- subset(plot.p.adjusted, plot.p.adjusted[,8] < 0.05 | plot.p.adjusted[,9] < 0.05)
if (nrow(P.less.0.05) > 0){
  P.less.0.05 <- plot.p.adjusted[,c(1:4)][which(plot.p.adjusted[,8] < 0.05),]
  ...
  library(lessR)
  total <- Merge(mrmlm.final, FarmCPU)
  #install.packages("tidyverse")
  library(tidyverse)
...
if (nrow(P.less.0.05) > 0){
  ...
  #install.packages("tidyverse")
  library(tidyverse)
  total <- tibble::rowid_to_column(mrmlm.final, "ID")
...
if (nrow(P.less.0.05) == 0){
  ...
  library(tidyverse)
  total <- tibble::rowid_to_column(mrmlm.final, "ID")
  write.csv(total, file="allresults/fprind_2.csv",row.names = F)
  ...
  total <- tibble::rowid_to_column(total, "ID")
  ###write the result
  write.csv(total, file="allresults/fprind_3.csv",row.names = F)
...
if (nrow(P.less.0.05) == 0){
  ...
  library(tidyverse)
  total <- tibble::rowid_to_column(mrmlm.final, "ID")
  write.csv(total, file="allresults/fprinW_2.csv",row.names = F)
  ...
  total <- tibble::rowid_to_column(total, "ID")
  ###write the result
  write.csv(total, file="allresults/fprinW_3.csv",row.names = F)
...
if (nrow(P.less.0.05) == 0){
  ...
  total <- tibble::rowid_to_column(total, "ID")
  ###write the result
  write.csv(total, file="allresults/fprinGW_3.csv",row.names = F)
...
if (nrow(P.less.0.05) == 0){
  ...
  total <- tibble::rowid_to_column(total, "ID")
  ###write the result
  write.csv(total, file="allresults/fprinM_3.csv",row.names = F)
