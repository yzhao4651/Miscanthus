...
write.csv(myGM.116.3077, file = "data/myGMfC.116.3077.csv",row.names = FALSE)
source("Function/FirstColumn.R")
myGD.116.3077 <- FirstColumn(myGD.116.3077)
write.csv(myGD.116.3077, file = "data/myGDfC.116.3077.csv",row.names = FALSE)


##############step5 myY: Phenotype data for GAPIT and FarmCPU 
##############step5 myY: Phenotype data for GAPIT and FarmCPU 
myY.116.3077 <- allblup[match(myGD.116.3077$Taxa,allblup$Taxa, nomatch=0),]
...
write.csv(myY.116.3077, file = "data/myYfC.116.3077.csv", row.names = FALSE, na = "")
...
write.csv(myQ.116.3077, file = "data/myQfC.116.3077.csv",row.names = FALSE)
