...
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.CmDW_g.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.CmDW_g"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.CmDW_g.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.CmDW_g"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.CmDW_g.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.CmDW_g"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.CmDW_g.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
colnames(MLMSUPER)[colnames(MLMSUPER)=="P.value"] <- "SUPER.CmDW_g"
gwasResultsqq <- read.csv("rrBLUPC116/rrBLUP_GWAS_results.C116.csv",row.names = 1)
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/CmDW_g_1.csv",row.names = F)
}

###plot QQ plot inone image
setwd("AllimagesC116/CmDW_g")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.CmDW_g.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.CmDW_g"
str(FarmCPU)
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.CmDW_g.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.CmDW_g"
intermediate <- read.csv("mrMLMM2/C116/1_intermediate result.csv")
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/1_final result.csv")
  ...
  write.csv(total, file="Culmallresults116/CmDW_g_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.Cml_cm.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.Cml_cm"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.Cml_cm.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.Cml_cm"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.Cml_cm.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.Cml_cm"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.Cml_cm.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/Cml_cm_1.csv",row.names = F)
}

###plot QQ plot inone image
setwd("AllimagesC116/Cml_cm")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.Cml_cm.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.Cml_cm"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.Cml_cm.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.Cml_cm"
intermediate <- read.csv("mrMLMM2/C116/2_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
P.less.0.05 <- subset(plot.p.adjusted, plot.p.adjusted[,8] < 0.05 | 
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/2_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/Cml_cm_2.csv",row.names = F)
    setwd("AllimagesC116/Cml_cm")
    #library("CMplot")
    source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
    library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.CmD_BI_mm.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.CmD_BI_mm"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.CmD_BI_mm.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.CmD_BI_mm"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.CmD_BI_mm.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.CmD_BI_mm"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.CmD_BI_mm.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/CmD_BI_mm_1.csv",row.names = F)
}

setwd("AllimagesC116/CmD_BI_mm")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
###plot QQ plot inone image
library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.CmD_BI_mm.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.CmD_BI_mm"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.CmD_BI_mm.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.CmD_BI_mm"
intermediate <- read.csv("mrMLMM2/C116/3_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/3_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/CmD_BI_mm_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.CmD_LI_mm.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.CmD_LI_mm"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.CmD_LI_mm.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.CmD_LI_mm"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.CmD_LI_mm.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.CmD_LI_mm"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.CmD_LI_mm.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/CmD_LI_mm_1.csv",row.names = F)
}

###plot QQ plot inone image
setwd("AllimagesC116/CmD_LI_mm")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.CmD_LI_mm.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.CmD_LI_mm"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.CmD_LI_mm.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.CmD_LI_mm"
intermediate <- read.csv("mrMLMM2/C116/4_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
P.less.0.05 <- subset(plot.p.adjusted, plot.p.adjusted[,8] < 0.05 | 
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/4_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/CmD_LI_mm_2.csv",row.names = F)
    setwd("AllimagesC116/CmD_LI_mm")
    #library("CMplot")
    source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
    library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.CmN..GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.CmN."
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.CmN..GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.CmN."
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.CmN..GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.CmN."
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.CmN..GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/CmN_1.csv",row.names = F)
}

###plot QQ plot inone image 
setwd("AllimagesC116/CmN")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.CmN..GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.CmN."
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.CmN..GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.CmN."
intermediate <- read.csv("mrMLMM2/C116/5_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
P.less.0.05 <- subset(plot.p.adjusted, plot.p.adjusted[,8] < 0.05 | 
  ...
  FarmCPU <- FarmCPU[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/5_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/CmN_2.csv",row.names = F)

    ###plot QQ plot inone image 
    setwd("AllimagesC116/Bcirc_cm")
    source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
    ###plot QQ plot inone image
    library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.Bcirc_cm.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.Bcirc_cm"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.Bcirc_cm.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.Bcirc_cm"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.Bcirc_cm.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.Bcirc_cm"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.Bcirc_cm.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/Bcirc_cm_1.csv",row.names = F)
}
...
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.Bcirc_cm.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.Bcirc_cm"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.Bcirc_cm.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.Bcirc_cm"
intermediate <- read.csv("mrMLMM2/C116/6_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
P.less.0.05 <- subset(plot.p.adjusted, plot.p.adjusted[,8] < 0.05 | 
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/6_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
   names(mrmlm.final) %in% names(FarmCPU)
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/Bcirc_cm_2.csv",row.names = F)
    ###plot QQ plot inone image 
    setwd("AllimagesC116/Yld_kg")
    source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.Yld_kg.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.Yld_kg"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.Yld_kg.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.Yld_kg"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.Yld_kg.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.Yld_kg"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.Yld_kg.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/Yld_kg_1.csv",row.names = F)
}
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.Yld_kg.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.Yld_kg"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.Yld_kg.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.Yld_kg"
intermediate <- read.csv("mrMLMM2/C116/7_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/7_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/Yld_kg_2.csv",row.names = F)
    setwd("AllimagesC116/Yld_kg")
    #library("CMplot")
    source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
    library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.SDW_kg.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.SDW_kg"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.SDW_kg.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.SDW_kg"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.SDW_kg.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.SDW_kg"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.SDW_kg.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/SDW_kg_1.csv",row.names = F)
}

###plot QQ plot inone image 
setwd("AllimagesC116/SDW_kg")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.SDW_kg.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.SDW_kg"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.SDW_kg.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.SDW_kg"
intermediate <- read.csv("mrMLMM2/C116/8_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
###merge all of them 
plot <-  plyr::join_all(list(FarmCPU,MLMM,FASTmrMLM,FASTmrEMMA), type = "left", by="SNP")
plot[is.na(plot)] <- 1
adj_P_function <- function(data,start_var, end_var,na.rm=TRUE){
  for(i in start_var:end_var){
    data[ ,paste0("Adj.P.",colnames(data[i]))] <- p.adjust(data[[i]], method ="bonferroni", n = length(data[[i]]))
...
P.less.0.05 <- subset(plot.p.adjusted, plot.p.adjusted[,8] < 0.05 | 
  ...
  FarmCPU <- plot.p.adjusted[,c(1:4)][which(plot.p.adjusted[,8] < 0.05),]
  colnames(FarmCPU)[colnames(FarmCPU)=="FarmCPU.SDW_kg"] <- "P.value"
  FarmCPU$Method <- paste("FarmCPU")
  FarmCPU$Trait.name <- paste("SDW_kg")
  FarmCPU <-  FarmCPU[,c(6,5,1:4)]
  MLMM <- plot.p.adjusted[,c(1:3,5)][which(plot.p.adjusted[,9] < 0.05),] 
  colnames(MLMM)[colnames(MLMM)=="MLMM.SDW_kg"] <- "P.value" 
  MLMM$Method <- paste("MLMM")  
  MLMM$Trait.name <- paste("SDW_kg") 
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/8_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/CCirc_cm_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.CCirc_cm.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.CCirc_cm"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.CCirc_cm.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.CCirc_cm"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.CCirc_cm.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.CCirc_cm"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.CCirc_cm.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
str(P.less.0.05)
write.csv(P.less.0.05, file="AllimagesC116/CCirc_cm/CCirc_cm.csv")
...
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/CCirc_cm_1.csv",row.names = F)
}

###plot QQ plot inone image 
setwd("AllimagesC116/CCirc_cm")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.CCirc_cm.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.CCirc_cm"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.CCirc_cm.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.CCirc_cm"
intermediate <- read.csv("mrMLMM2/C116/9_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/9_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.Lg.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.Lg"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.Lg.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.Lg"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.Lg.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.Lg"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.Lg.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/Lg_1.csv",row.names = F)
}

###plot QQ plot inone image 
setwd("AllimagesC116/Lg")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.Lg.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
str(FarmCPU)
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.Lg"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.Lg.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.Lg"
intermediate <- read.csv("mrMLMM2/C116/10_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/10_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  names(mrmlm.final) %in% names(FarmCPU)
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/Lg_2.csv",row.names = F)
    setwd("AllimagesC116/Lg")
    #library("CMplot")
    source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
    library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.GS.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.GS"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.GS.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.GS"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.GS.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.GS"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.GS.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/GS_1.csv",row.names = F)
}

###plot QQ plot inone image
setwd("AllimagesC116/GS")
#library("CMplot")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.GS.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
str(FarmCPU)
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.GS"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.GS.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.GS"
intermediate <- read.csv("mrMLMM2/C116/11_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
P.less.0.05 <- subset(plot.p.adjusted, plot.p.adjusted[,8] < 0.05 | 
  ...
  FarmCPU <- FarmCPU[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/11_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  names(mrmlm.final) %in% names(FarmCPU)
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/GS_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.FD.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.FD"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.FD.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.FD"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.FD.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.FD"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.FD.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/FD_1.csv",row.names = F)
}

###plot QQ plot inone image
setwd("AllimagesC116/FD")
#library("CMplot")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
###plot QQ plot inone image
library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.FD.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
str(FarmCPU)
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.FD"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.FD.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.FD"
intermediate <- read.csv("mrMLMM2/C116/12_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
P.less.0.05 <- subset(plot.p.adjusted, plot.p.adjusted[,8] < 0.05 | 
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/12_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/FD_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.SRD.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.SRD"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.SRD.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.SRD"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.SRD.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.SRD"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.SRD.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/SRD_1.csv",row.names = F)
}

setwd("AllimagesC116/SRD")
#library("CMplot")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
library("CMplot")
CMplot(plot,plot.type="q",col=c("blue", "orange", "cyan","magenta","green3"),threshold=0.05/nrow(plot),
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.SRD.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
str(FarmCPU)
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.SRD"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.SRD.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.SRD"
intermediate <- read.csv("mrMLMM2/C116/13_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  FarmCPU <- FarmCPU[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/13_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(2:6,15)]
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/SRD_2.csv",row.names = F)
 
    ###plot QQ plot inone image
    setwd("AllimagesC116/ADD")
    #library("CMplot")
    source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
    ###plot QQ plot inone image
    library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.GLM.ADD.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.ADD"
str(GLM)
MLM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPUCV/GAPIT.MLM.ADD.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.ADD"
CMLM <- read.csv("Result GAPIT1/C116ECMMLCV/GAPIT.CMLM.ADD.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.ADD"
MLMSUPER <- read.csv("Result GAPIT1/C116MLMSUPPER/GAPIT.SUPER.ADD.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="Culmallresults116/ADD_1.csv",row.names = F)
}
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.ADD.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
str(FarmCPU)
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.ADD"
MLMM <- read.csv("Result GAPIT1/C116GLMMLMMLMMFarmCPU/GAPIT.MLMM.ADD.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.ADD"
intermediate <- read.csv("mrMLMM2/C116/14_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/C116/14_final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  names(FarmCPU) %in% names(mrmlm.final)
    ...
    total$SNP.N <- paste("116")
    total <- unique(total[,c(7,1:6)])
    write.csv(total, file="Culmallresults116/ADD_2.csv",row.names = F)
    setwd("AllimagesC116/ADD")
    #library("CMplot")
    source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
    library("CMplot")
