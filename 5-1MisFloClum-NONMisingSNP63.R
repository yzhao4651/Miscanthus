...
write.csv(myGM.122.2272, file = "data/myGMfC.122.2272.csv",row.names = FALSE)
source("Function/FirstColumn.R")
myGD.122.2272 <- FirstColumn(myGD.122.2272)
write.csv(myGD.122.2272, file = "data/myGDfC.122.2272.csv",row.names = FALSE)


##############step5 myY: Phenotype data for GAPIT and FarmCPU 
##############step5 myY: Phenotype data for GAPIT and FarmCPU 
myY.122.2272 <- allblup[match(myGD.122.2272$Taxa,allblup$Taxa, nomatch=0),]
...
write.csv(myY.122.2272, file = "data/myYfC.122.2272.csv", row.names = FALSE, na = "")
...
write.csv(myQ.122.2272, file = "data/myQfC.122.2272.csv",row.names = FALSE)
