##question: I get one column with file name, but it is very long,
##how i can get only Method.var like MLM.ADD?
##i did method one by one, it is possible we can get all of them on one function?
