...
write.csv(myGM.119.2988, file = "data/myGMf.119.2988.csv",row.names = FALSE)
source("Function/FirstColumn.R")
myGD.119.2988 <- FirstColumn(myGD.119.2988)
str(myGD.119.2988)
write.csv(myGD.119.2988, file = "data/myGDf.119.2988.csv",row.names = FALSE)


##############step5 myY: Phenotype data for GAPIT and FarmCPU 
##############step5 myY: Phenotype data for GAPIT and FarmCPU 
myY.119.2988 <- allblup[match(myGD.119.2988$Taxa,allblup$Taxa, nomatch=0),]
...
write.csv(myY.119.2988, file = "data/myYf.119.2988.csv", row.names = FALSE, na = "")
...
write.csv(myQ.119.2988, file = "data/myQf.119.2988.csv",row.names = FALSE)
