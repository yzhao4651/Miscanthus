...
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.HD_1.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.HD_1"
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.HD_1.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.HD_1"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.HD_1.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.HD_1"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.HD_1.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
colnames(MLMSUPER)[colnames(MLMSUPER)=="P.value"] <- "SUPER.HD_1"
gwasResultsqq <- read.csv("rrBLUPF122/rrBLUP_GWAS_results.flo122.csv",row.names = 1)
...
total$SNP.N <- paste("122")
total <- total[,c(7,6,5,1:4)]
str(total)
###write the result
if (nrow(total)>0) {
write.csv(total, file="floallresults122/HD_1_1.csv",row.names = F)
}
###plot QQ plot inone image
setwd("Allimagef122/HD_1")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus/")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.HD_1.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.HD_1"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.HD_1.GWAS.Results.csv")
#MLMM <- read.csv("Result GAPIT1/MLMM/GAPIT.MLMM.HD_1.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.HD_1"
intermediate <- read.csv("mrMLMM2/F122/4_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
qq(intermediate$X.log10.P.)
...
MLMM <- MLMM[,c(6,5,1:4)]
mrmlm.final <- read.csv("mrMLMM2/F122/4_Final result.csv")
...
###write the result
write.csv(total, file="floallresults122/HD_1_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.FD_1.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.FD_1"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.FD_1.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.FD_1"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.FD_1.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.FD_1"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.FD_1.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/FD_1_1.csv",row.names = F)
}

###plot QQ plot inone image
setwd("Allimagef122/FD_1")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus/")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.FD_1.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.FD_1"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.FD_1.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.FD_1"
intermediate <- read.csv("mrMLMM2/F122/5_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  mrmlm.final <- read.csv("mrMLMM2/F122/5_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/FD_1_2.csv",row.names = F)
...
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
#setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.GLM.HD_50..GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.HD_50."
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLM.HD_50..GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.HD_50."
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.HD_50..GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.HD_50."
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.HD_50..GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/HD_50_1.csv",row.names = F)
}


###plot QQ plot inone image
setwd("Allimagef122/HD_50")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.HD_50..GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.HD_50."
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.HD_50..GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.HD_50."
intermediate <- read.csv("mrMLMM2/F122/6_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  mrmlm.final <- read.csv("mrMLMM2/F122/6_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/HD_50_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.FD_50..GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.FD_50."
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.FD_50..GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.FD_50."
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.FD_50..GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.FD_50."
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.FD_50..GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/FD_50_1.csv",row.names = F)
}



###plot QQ plot inone image
setwd("Allimagef122/FD_50")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.FD_50..GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.FD_50."
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.FD_50..GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.FD_50."
intermediate <- read.csv("mrMLMM2/F122/7_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/7_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/FD_50_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.HW_1.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.HW_1"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.HW_1.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.HW_1"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.HW_1.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.HW_1"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.HW_1.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/HW_1_1.csv",row.names = F)
}



###plot QQ plot inone image
setwd("Allimagef122/HW_1")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
###plot QQ plot inone image
library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.HW_1.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.HW_1"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.HW_1.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.HW_1"
intermediate <- read.csv("mrMLMM2/F122/8_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/8_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/HW_1_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.FW_1.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.FW_1"

MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.FW_1.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.FW_1"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.FW_1.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.FW_1"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.FW_1.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/FW_1_1.csv",row.names = F)
}



###plot QQ plot inone image
setwd("Allimagef122/FW_1")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.FW_1.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.FW_1"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.FW_1.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.FW_1"
intermediate <- read.csv("mrMLMM2/F122/9_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/9_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/FW_1_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.HW_50.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.HW_50."
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.HW_50.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.HW_50."
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.HW_50.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.HW_50."
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.HW_50.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/HW_50_1.csv",row.names = F)
}


###plot QQ plot inone image
setwd("Allimagef122/HW_50")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.HW_50.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.HW_50."
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.HW_50.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.HW_50."
intermediate <- read.csv("mrMLMM2/F122/10_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/10_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/HW_50_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.FW_50.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.FW_50."
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.FW_50.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.FW_50."
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.FW_50.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.FW_50."
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.FW_50.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/FW_50_1.csv",row.names = F)
}

setwd("Allimagef122/FW_50")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.FW_50.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.FW_50."
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.FW_50.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.FW_50."
intermediate <- read.csv("mrMLMM2/F122/11_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/11_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/FW_50_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.GHW_1.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.GHW_1"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.GHW_1.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.GHW_1"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.GHW_1.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.GHW_1"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.GHW_1.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/GHW_1_1.csv",row.names = F)
}


setwd("Allimagef122/GHW_1")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.GHW_1.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.GHW_1"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.GHW_1.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.GHW_1"
intermediate <- read.csv("mrMLMM2/F122/12_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/12_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final$SNP.N <- paste("122")
  mrmlm.final<- mrmlm.final[,c(7,1:6)]
  write.csv(mrmlm.final, file="floallresults122/GHW_1_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.GFW_1.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.GFW_1"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.GFW_1.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.GFW_1"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.GFW_1.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.GFW_1"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.GFW_1.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/GFW_1_1.csv",row.names = F)
}



###plot QQ plot inone image
setwd("Allimagef122/GFW_1")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.GFW_1.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.GFW_1"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.GFW_1.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.GFW_1"
intermediate <- read.csv("mrMLMM2/F122/13_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/13_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/GFW_1_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.GHW_50.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.GHW_50."
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.GHW_50.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.GHW_50."
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.GHW_50.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.GHW_50."
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.GHW_50.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/GFW_50_1.csv",row.names = F)
}


###plot QQ plot inone image
setwd("Allimagef122/GHW_50")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.GHW_50.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.GHW_50."
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.GHW_50.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.GHW_50."
intermediate <- read.csv("mrMLMM2/F122/14_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
FarmCPU <- subset(plot.p.adjusted, plot.p.adjusted[,7] < 0.05 | 
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/14_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  mrmlm.final <- mrmlm.final[,c(7,1:6)]
  ###write the result
  write.csv(mrmlm.final, file="floallresults122/GHW_50_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.GFW_50.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.GFW_50."
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.GFW_50.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.GFW_50."
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.GFW_50.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.GFW_50."
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.GFW_50.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.GFW_50.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.GFW_50."
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.GFW_50.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.GFW_50."
intermediate <- read.csv("mrMLMM2/F122/15_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/15_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/GFW_50_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.HM_1.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.HM_1"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.HM_1.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.HM_1"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.HM_1.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.HM_1"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.HM_1.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/HM_1_1.csv",row.names = F)
}



###plot QQ plot inone image
setwd("Allimagef122/HM_1")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
###plot QQ plot inone image
library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.HM_1.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.HM_1"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.HM_1.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.HM_1"
intermediate <- read.csv("mrMLMM2/F122/16_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
###merge all of them 
plot <-  plyr::join_all(list(FarmCPU,MLMM,mrMLM,FASTmrMLM,FASTmrEMMA,pKWmEB), type = "left", by="SNP")
plot[is.na(plot)] <- 1
str(plot)
source("Function/adj_P_functionb.R")
plot.p.adjusted <- adj_P_function(plot, 4, 5)
...
FarmCPU <- subset(plot.p.adjusted, plot.p.adjusted[,7] < 0.05 | 
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/16_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/HM_1_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.FM_1.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.FM_1"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.FM_1.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.FM_1"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.FM_1.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.FM_1"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.FM_1.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/FM_1_1.csv",row.names = F)
}


###plot QQ plot inone image
setwd("Allimagef122/FM_1")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
###plot QQ plot inone image
library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.FM_1.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.FM_1"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.FM_1.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.FM_1"
intermediate <- read.csv("mrMLMM2/F122/17_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/17_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/FM_1_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.HM_50.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.HM_50."
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.HM_50.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.HM_50."
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.HM_50.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.HM_50."
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.HM_50.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/HM_50_1.csv",row.names = F)
}



###plot QQ plot inone image
setwd("Allimagef122/HM_50")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.HM_50.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.HM_50."
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.HM_50.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.HM_50."
intermediate <- read.csv("mrMLMM2/F122/18_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/18_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/HM_50_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.FM_50.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.FM_50."
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.FM_50.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.FM_50."
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.FM_50.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.FM_50."
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.FM_50.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/FM_50_1.csv",row.names = F)
}



###plot QQ plot inone image
setwd("Allimagef122/FM_50")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
###plot QQ plot inone image
library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.FM_50.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.FM_50."
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.FM_50.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.FM_50."
intermediate <- read.csv("mrMLMM2/F122/19_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/19_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/FM_50_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.fprind.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.fprind"
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.fprind.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.fprind"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.fprind.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.fprind"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.fprind.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/fprind_1.csv",row.names = F)
}



###plot QQ plot inone image
setwd("Allimagef122/fprind")
library("CMplot")
CMplot(plot,plot.type="q",col=c("blue", "orange", "cyan","magenta","green3"),threshold=0.05/nrow(plot),
       signal.pch=19,cex=0.5,signal.cex=1.0, signal.col="blue",conf.int.col="grey",box=FALSE,multracks=
         TRUE,file="jpg",memo="",dpi=300,
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.fprind.GWAS.Results.csv")
colnames(FarmCPU)[colnames(FarmCPU)=="Name"] <- "SNP"
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.fprind"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.fprind.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.fprind"
intermediate <- read.csv("mrMLMM2/F122/20_intermediate result.csv")
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/20_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/fprind_2.csv",row.names = F)

setwd("Allimagef122/fprindCV")
#library("CMplot")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
CMplot(plot,plot.type="q",col=c("blue", "orange", "cyan","magenta","green3"),threshold=0.05/nrow(plot),
       signal.pch=19,cex=0.5,signal.cex=1.0, signal.col="blue",conf.int.col="grey",box=FALSE,multracks=
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.fprinW.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.fprinW"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.fprinW.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.fprinW"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.fprinW.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.fprinW"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.fprinW.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/fprinW_1.csv",row.names = F)
}



###plot QQ plot inone image
setwd("Allimagef122/fprinW")
#library("CMplot")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.fprinW.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.fprinW"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.fprinW.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.fprinW"
intermediate <- read.csv("mrMLMM2/F122/21_intermediate result.csv")
levels(intermediate$Trait.name) 
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/21_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/fprinW_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.fprinGW.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.fprinGW"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.fprinGW.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.fprinGW"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.fprinGW.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.fprinGW"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.fprinGW.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/fprinGW_1.csv",row.names = F)
}


###plot QQ plot inone image
setwd("Allimagef122/fprinGW")
#library("CMplot")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.fprinGW.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.fprinGW"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.fprinGW.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.fprinGW"
intermediate <- read.csv("mrMLMM2/F122/22_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/22_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total <- unique(total[,c(7,1:6)])
  ###write the result
  write.csv(total, file="floallresults122/fprinGW_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.fprinM.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.fprinM"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.fprinM.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.fprinM"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.fprinM.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.fprinM"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.fprinM.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/fprinM_1.csv",row.names = F)
}


###plot QQ plot inone image
setwd("Allimagef122/fprinM")
#library("CMplot")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
###plot QQ plot inone image
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.fprinM.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.fprinM"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.fprinM.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.fprinM"
intermediate <- read.csv("mrMLMM2/F122/23_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/23_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total <- unique(total[,c(7,1:6)])
  ###write the result
  write.csv(total, file="floallresults122/fprinM_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.TFN..GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.TFN."
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.TFN..GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.TFN."
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.TFN..GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.TFN."
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.TFN..GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
##write out results
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/TFN_1.csv",row.names = F)
}

###plot QQ plot inone image
setwd("Allimagef122/TFN")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
library("CMplot")
CMplot(plot,plot.type="q",col=c("blue", "orange", "cyan","magenta","green3"),threshold=0.05/nrow(plot),
       signal.pch=19,cex=0.5,signal.cex=1.0, signal.col="blue",conf.int.col="grey",box=FALSE,multracks=
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.TFN..GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
...
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.TFN..GWAS.Results.csv")
MLMM <- read.csv("Result GAPIT1/MLMM/GAPIT.MLMM.TFN..GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.TFN."
intermediate <- read.csv("mrMLMM2/F122/1_intermediate result.csv")
str(intermediate)
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/1_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/TFN_2.csv",row.names = F)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.FNMain.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.FNMain"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.FNMain.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.FNMain"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.FNMain.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.FNMain"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.FNMain.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
###write the result
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/FNMain_1.csv",row.names = F)
}

###plot QQ plot inone image
setwd("Allimagef122/FNMain")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
###plot QQ plot inone image
library("CMplot")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.FNMain.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]

colnames(FarmCPU)[colnames(FarmCPU)=="P.value"] <- "FarmCPU.FNMain"
MLMM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.MLMM.FNMain.GWAS.Results.csv")
MLMM <- MLMM[,c(1,4)]
colnames(MLMM)[colnames(MLMM)=="P.value"] <- "MLMM.FNMain"
intermediate <- read.csv("mrMLMM2/F122/2_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
str(plot.p.adjusted)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/2_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total <- unique(total[,c(7,1:6)])
  ###write the result
  write.csv(total, file="floallresults122/FNMain_2.csv",row.names = F)
...
##this one for laptop
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
GLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.GLM.FNsmall.GWAS.Results.csv")
GLM <- GLM[1:4]
colnames(GLM)[colnames(GLM)=="P.value"] <- "GLM.FNsmall"
str(GLM)
MLM <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPUCV/GAPIT.MLM.FNsmall.GWAS.Results.csv")
MLM <- MLM[,c(1,4)]
colnames(MLM)[colnames(MLM)=="P.value"] <- "MLM.FNsmall"
CMLM <- read.csv("Result GAPIT1/f122ECMMLCV/GAPIT.CMLM.FNsmall.GWAS.Results.csv")
CMLM <- CMLM[,c(1,4)]
colnames(CMLM)[colnames(CMLM)=="P.value"] <- "CMLM.FNsmall"
MLMSUPER <- read.csv("Result GAPIT1/f122MLMSUPPER/GAPIT.SUPER.FNsmall.GWAS.Results.csv")
MLMSUPER<- MLMSUPER[,c(1,4)]
...
if (nrow(total)>0) {
  write.csv(total, file="floallresults122/FNsmall_1.csv",row.names = F)
}

###plot QQ plot inone image
setwd("Allimagef122/FNsmall")
source("https://raw.githubusercontent.com/YinLiLin/R-CMplot/master/R/CMplot.r")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus/")
FarmCPU <- read.csv("Result GAPIT1/f122GLMMLMMLMMFarmCPU/GAPIT.FarmCPU.FNsmall.GWAS.Results.csv")
FarmCPU <- FarmCPU[1:4]
...
intermediate <- read.csv("mrMLMM2/F122/3_intermediate result.csv")
intermediate$X.log10.P. <- 10^-(intermediate$X.log10.P.)
colnames(intermediate)[colnames(intermediate)=="RS."] <- "SNP"
intermediate <- intermediate[,c(3:4,8)]
levels(intermediate$Method)
...
plot.p.adjusted <- adj_P_function(plot, 4, 5)
  ...
  MLMM <- MLMM[,c(6,5,1:4)]
  ###The result from mrMLM
  mrmlm.final <- read.csv("mrMLMM2/F122/3_Final result.csv")
  colnames(mrmlm.final)[colnames(mrmlm.final) == "RS."] <- "SNP"
  colnames(mrmlm.final)[colnames(mrmlm.final) == "Marker.Position..bp."] <- "Position"
  ...
  total$SNP.N <- paste("122")
  total <- unique(total[,c(7,1:6)])
  write.csv(total, file="floallresults122/FNsmall_2.csv",row.names = F)
