...
write.csv(myGM.106.4202, file = "data/myGMf.106.4202.csv",row.names = FALSE)
source("Function/FirstColumn.R")
myGD.106.4202 <- FirstColumn(myGD.106.4202)
str(myGD.106.4202)
write.csv(myGD.106.4202, file = "data/myGDf.106.4202.csv",row.names = FALSE)


##############step5 myY: Phenotype data for GAPIT and FarmCPU 
##############step5 myY: Phenotype data for GAPIT and FarmCPU 
myY.106.4202 <- allblup[match(myGD.106.4202$Taxa,allblup$Taxa, nomatch=0),]
...
write.csv(myY.106.4202, file = "data/myYf.106.4202.csv", row.names = FALSE, na = "")
...
write.csv(myQ.106.4202, file = "data/myQf.106.4202.csv",row.names = FALSE)
