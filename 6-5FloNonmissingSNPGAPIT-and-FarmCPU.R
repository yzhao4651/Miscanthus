...
myGD <- read.csv("data/myGDflo.106.4178.csv")
myGM <- read.csv("data/myGMflo.106.4178.csv")
myQ<- read.csv("data/myQflo.106.4178.csv")
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo106/modelselection")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM,
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo106/SNPNOCV")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo106/SNPCV")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM,
...
###########"GLM","MLM","MLMM","FarmCPU" without CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo106/GLMMLMMLMMFarmCPU")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########"GLM","MLM","MLMM","FarmCPU" with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo106/GLMMLMMLMMFarmCPUCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########Using GLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo106/GLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########Using CMLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo106/CMLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########Using SUPPER SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo106/SUPPERSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  myGD <- read.csv("data/myGDflo.115.3154.csv")
  myGM <- read.csv("data/myGMflo.115.3154.csv")
  myQ<- read.csv("data/myQflo.115.3154.csv")

  
  ####Basic Scenario with Model selection in order to find the optimal number of PCs for different traits. 
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/modelselection")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  ####Basic Scenario using PCs=0 without incoporating CV:Population Structure
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/SNPNOCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM
  ...
  ####Basic Scenario using PCs=0 with incoporate CV:Population Structure
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/SNPCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  ####Enhanced Compression without CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/ECMMLNOCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  ####Enhanced Compression with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/ECMMLCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  ###########"GLM","MLM","MLMM","FarmCPU" without CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/GLMMLMMLMMFarmCPU")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  ###########"GLM","MLM","MLMM","FarmCPU" with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/GLMMLMMLMMFarmCPUCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  ####becasue i saw the example does not use the PCA, but CV in the manual 
  ##########Using MLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/MLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  ###########Using GLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/GLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  ###########Using CMLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/CMLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  ###########Using SUPPER SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/GAPITflo115/SUPPERSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
