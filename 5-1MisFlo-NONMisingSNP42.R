...
write.csv(myGM.125.2562, file = "data/myGMf.125.2562.csv",row.names = FALSE)
source("Function/FirstColumn.R")
myGD.125.2562 <- FirstColumn(myGD.125.2562)
str(myGD.125.2562)
write.csv(myGD.125.2562, file = "data/myGDf.125.2562.csv",row.names = FALSE)


##############step5 myY: Phenotype data for GAPIT and FarmCPU 
##############step5 myY: Phenotype data for GAPIT and FarmCPU 
myY.125.2562 <- allblup[match(myGD.125.2562$Taxa,allblup$Taxa, nomatch=0),]
...
write.csv(myY.125.2562, file = "data/myYf.125.2562.csv", row.names = FALSE, na = "")
...
write.csv(myQ.125.2562, file = "data/myQf.125.2562.csv",row.names = FALSE)
