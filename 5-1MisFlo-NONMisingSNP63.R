...
write.csv(myGM.130.2001, file = "data/myGMf.130.2001.csv",row.names = FALSE)
source("Function/FirstColumn.R")
myGD.130.2001 <- FirstColumn(myGD.130.2001)
str(myGD.130.2001)
write.csv(myGD.130.2001, file = "data/myGDf.130.2001.csv",row.names = FALSE)


##############step5 myY: Phenotype data for GAPIT and FarmCPU 
##############step5 myY: Phenotype data for GAPIT and FarmCPU 
myY.130.2001 <- allblup[match(myGD.130.2001$Taxa,allblup$Taxa, nomatch=0),]
...
write.csv(myY.130.2001, file = "data/myYf.130.2001.csv", row.names = FALSE, na = "")
...
write.csv(myQ.130.2001, file = "data/myQf.130.2001.csv",row.names = FALSE)
