...
myGD <- read.csv("data/myGD.112.4877.csv")
myGM <- read.csv("data/myGM.112.4877.csv")
myQ<- read.csv("data/myQ.112.4877.csv")
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112modelselection")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM,
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112SNPNOCV")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112SNPCV")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM,
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112ECMMLNOCV")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM,
...
####Enhanced Compression with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112ECMMLCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########"GLM","MLM","MLMM","FarmCPU" without CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112GLMMLMMLMMFarmCPU")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########"GLM","MLM","MLMM","FarmCPU" with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112GLMMLMMLMMFarmCPUCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
##########Using MLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112MLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########Using GLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112GLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########Using CMLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112CMLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########Using SUPPER SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/112SUPPERSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
