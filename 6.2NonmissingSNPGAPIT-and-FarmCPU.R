...
myY <- read.csv("data/myY.136.3387.csv")
myGD <- read.csv("data/myGD.136.3387.csv")
myGM <- read.csv("data/myGM.136.3387.csv")
myQ<- read.csv("data/myQ.136.3387.csv")
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136modelselection")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM,
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136SNPNOCV")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136SNPCV")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM,
...
setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136ECMMLNOCV")
myGAPIT <- GAPIT(
  Y=myY,
  GD=myGD,
  GM=myGM,
...
####Enhanced Compression with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136ECMMLCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########"GLM","MLM","MLMM","FarmCPU" without CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136GLMMLMMLMMFarmCPU")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########"GLM","MLM","MLMM","FarmCPU" with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136GLMMLMMLMMFarmCPUCV")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
##########Using MLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136MLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########Using GLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136GLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########Using CMLM SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136CMLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
...
###########Using SUPPER SUPPER with CV
  setwd("~/Documents/R-corde for miscanthus project/Miscanthus/Result GAPIT/136SUPPERSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
