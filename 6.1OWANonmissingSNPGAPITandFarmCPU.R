...
###CMLM, SUPPER
  ...
  setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus/Result GAPIT1/106OWAMLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus/Result GAPIT1/116OWAMLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus/Result GAPIT1/126OWAMLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
  ...
  setwd("C:/Users/Admin/Desktop/Miscanthus/Miscanthus/Result GAPIT1/135OWAMLMSUPPER")
  myGAPIT <- GAPIT(
    Y=myY,
    GD=myGD,
    GM=myGM,
