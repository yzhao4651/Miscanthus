...
flo <- flo.1[flo.1$Ind.SNP=="+36088im" & flo.1$Method=="CMLM+SUPER",]
str(flo)
names(flo)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/CMLMSUPER0.05.36088im")
...
extension <- "csv"
fileNames <- Sys.glob(paste("CMLMSUPER0.05.36088im/*.", extension, sep = ""))
...
CMLMCUPERim$filename <- gsub('CMLMSUPER0.05.36088im/Trait.', '', CMLMCUPERim$filename)
...
flo <- flo.1[flo.1$Ind.SNP=="F116+3077" & flo.1$Method=="CMLM+SUPER",]

flo <- flo[!(flo$Trait.name=="Surv"),]

setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/CMLMSUPER0.05.F116")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("CMLMSUPER0.05.F116/*.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
  sample.PVE <- PVE.fun(sample,myY,myGD)
...
CMLMSUPER0.05.F116$filename <- gsub('CMLMSUPER0.05.F116/Trait.', '', CMLMSUPER0.05.F116$filename)
...
flo <- flo.1[flo.1$Ind.SNP=="F122+2272" & flo.1$Method=="CMLM+SUPER",]
str(flo)

flo <- flo[!(flo$Trait.name=="Surv"),]

str(flo)
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/CMLMSUPER0.05.F122")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("CMLMSUPER0.05.F122/*.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
  sample.PVE <- PVE.fun(sample,myY,myGD)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
CMLMSUPER0.05.F122 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(CMLMSUPER0.05.F122$filename)

CMLMSUPER0.05.F122$filename <- gsub('CMLMSUPER0.05.F122/Trait.', '', CMLMSUPER0.05.F122$filename)
CMLMSUPER0.05.F122$filename <- gsub('.csv', '', CMLMSUPER0.05.F122$filename)

levels(as.factor(CMLMSUPER0.05.F122$filename))

CMLMSUPER0.05.F122.1 <- unite(CMLMSUPER0.05.F122,"SNP.T", SNP, filename, sep="/")
flo.2 <- unite(flo,"SNP.T", SNP, Trait.name, sep="/")

CMLMSUPER0.05.F122.flo <- merge(flo.2,CMLMSUPER0.05.F122.1, by="SNP.T")
CMLMSUPER0.05.F122.flo.S <- separate(CMLMSUPER0.05.F122.flo, SNP.T, c("SNP","Trait.name"),sep="/")
str(CMLMSUPER0.05.F122.flo.S)
...
flo.1 <- read.csv("Result.8.3/MLMCMLMSUPER0.05.Adj.P.PS.csv")
flo <- flo.1[flo.1$Ind.SNP=="C125+2562" & flo.1$Method=="CMLM+SUPER",]
flo <- flo[!(flo$Trait.name=="Surv"),]


setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/CMLMSUPER0.05.C125")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("CMLMSUPER0.05.C125/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
CMLMSUPER0.05.C125 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(CMLMSUPER0.05.C125$filename)

CMLMSUPER0.05.C125$filename <- gsub('CMLMSUPER0.05.C125/Trait.', '', CMLMSUPER0.05.C125$filename)
CMLMSUPER0.05.C125$filename <- gsub('.csv', '', CMLMSUPER0.05.C125$filename)

levels(as.factor(CMLMSUPER0.05.C125$filename))

CMLMSUPER0.05.C125.1 <- unite(CMLMSUPER0.05.C125,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

CMLMSUPER0.05.C125.flo <- merge(flo.2,CMLMSUPER0.05.C125.1,by="SNP.T")
CMLMSUPER0.05.C125.flo.S <- separate(CMLMSUPER0.05.C125.flo, SNP.T, c("SNP","Trait.name"),sep="/")
...
flo.1 <- read.csv("Result.8.3/MLMCMLMSUPER0.05.Adj.P.PS.csv")
flo <- flo.1[flo.1$Ind.SNP=="O106+4834" & flo.1$Method=="CMLM+SUPER",]
flo <- flo[!(flo$Trait.name=="Surv"),]


setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/CMLMSUPER0.05.O106")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("CMLMSUPER0.05.O106/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
CMLMSUPER0.05.O106 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(CMLMSUPER0.05.O106$filename)

CMLMSUPER0.05.O106$filename <- gsub('CMLMSUPER0.05.O106/Trait.', '', CMLMSUPER0.05.O106$filename)
CMLMSUPER0.05.O106$filename <- gsub('.csv', '', CMLMSUPER0.05.O106$filename)

levels(as.factor(CMLMSUPER0.05.O106$filename))

CMLMSUPER0.05.O106.1 <- unite(CMLMSUPER0.05.O106,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

CMLMSUPER0.05.O106.flo <- merge(flo.2,CMLMSUPER0.05.O106.1,by="SNP.T")
CMLMSUPER0.05.O106.flo.S <- separate(CMLMSUPER0.05.O106.flo, SNP.T, c("SNP","Trait.name"),sep="/")
...
flo.1 <- read.csv("Result.8.3/MLMCMLMSUPER0.05.Adj.P.PS.csv")
flo <- flo.1[flo.1$Ind.SNP=="O116+4232" & flo.1$Method=="CMLM+SUPER",]
flo <- flo[!(flo$Trait.name=="Surv"),]


setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/CMLMSUPER0.05.O116")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("CMLMSUPER0.05.O116/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
CMLMSUPER0.05.O116 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(CMLMSUPER0.05.O116$filename)

CMLMSUPER0.05.O116$filename <- gsub('CMLMSUPER0.05.O116/Trait.', '', CMLMSUPER0.05.O116$filename)
CMLMSUPER0.05.O116$filename <- gsub('.csv', '', CMLMSUPER0.05.O116$filename)

levels(as.factor(CMLMSUPER0.05.O116$filename))

CMLMSUPER0.05.O116.1 <- unite(CMLMSUPER0.05.O116,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

CMLMSUPER0.05.O116.flo <- merge(flo.2,CMLMSUPER0.05.O116.1,by="SNP.T")
CMLMSUPER0.05.O116.flo.S <- separate(CMLMSUPER0.05.O116.flo, SNP.T, c("SNP","Trait.name"),sep="/")
...
flo.1 <- read.csv("Result.8.3/MLMCMLMSUPER0.05.Adj.P.PS.csv")
flo <- flo.1[flo.1$Ind.SNP=="O126+3659" & flo.1$Method=="CMLM+SUPER",]
flo <- flo[!(flo$Trait.name=="Surv"),]


setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/CMLMSUPER0.05.O126")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("CMLMSUPER0.05.O126/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
CMLMSUPER0.05.O126 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(CMLMSUPER0.05.O126$filename)

CMLMSUPER0.05.O126$filename <- gsub('CMLMSUPER0.05.O126/Trait.', '', CMLMSUPER0.05.O126$filename)
CMLMSUPER0.05.O126$filename <- gsub('.csv', '', CMLMSUPER0.05.O126$filename)

levels(as.factor(CMLMSUPER0.05.O126$filename))

CMLMSUPER0.05.O126.1 <- unite(CMLMSUPER0.05.O126,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

CMLMSUPER0.05.O126.flo <- merge(flo.2,CMLMSUPER0.05.O126.1,by="SNP.T")
CMLMSUPER0.05.O126.flo.S <- separate(CMLMSUPER0.05.O126.flo, SNP.T, c("SNP","Trait.name"),sep="/")
...
flo.1 <- read.csv("Result.8.3/MLMCMLMSUPER0.05.Adj.P.PS.csv")
flo <- flo.1[flo.1$Ind.SNP=="O135+2855" & flo.1$Method=="CMLM+SUPER",]
flo <- flo[!(flo$Trait.name=="Surv"),]


setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/CMLMSUPER0.05.O135")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("CMLMSUPER0.05.O135/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
CMLMSUPER0.05.O135 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(CMLMSUPER0.05.O135$filename)

CMLMSUPER0.05.O135$filename <- gsub('CMLMSUPER0.05.O135/Trait.', '', CMLMSUPER0.05.O135$filename)
CMLMSUPER0.05.O135$filename <- gsub('.csv', '', CMLMSUPER0.05.O135$filename)

levels(as.factor(CMLMSUPER0.05.O135$filename))

CMLMSUPER0.05.O135.1 <- unite(CMLMSUPER0.05.O135,"SNP.T",SNP,filename, sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

CMLMSUPER0.05.O135.flo <- merge(flo.2,CMLMSUPER0.05.O135.1,by="SNP.T")
CMLMSUPER0.05.O135.flo.S <- separate(CMLMSUPER0.05.O135.flo, SNP.T, c("SNP","Trait.name"),sep="/")

###combine all of file together 
CMLMSUPER0.05.PVE.a <- do.call("rbind",list(CMLMSUPER0.05.C106.flo.S,CMLMSUPER0.05.C116.flo.S,CMLMSUPER0.05.C125.flo.S,CMLMSUPER0.05.O106.flo.S,
                                        CMLMSUPER0.05.O116.flo.S,CMLMSUPER0.05.O126.flo.S,CMLMSUPER0.05.O135.flo.S,CMLMCUPERim.flo.S,
                                        CMLMSUPER0.05.F106.flo.S,CMLMSUPER0.05.F116.flo.S,CMLMSUPER0.05.F122.flo.S))
write.csv(CMLMSUPER0.05.PVE.a,file="Result.8.3/CMLMSUPER0.05.PS.PVE.a.csv")
